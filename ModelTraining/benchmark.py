...
good_pl_args = {"model_id":os.path.abspath(f"model_convV3.tflite"),
                "max_num_states" : 1000,
                "pred_format" : "bitmap",
                }

game_kwargs = {
        "model_paths" : [os.path.abspath(f"model_convV3.tflite")],
}
...
clean_up()
BENCH3.run(test_player, cpus=15, chunksize=1, ngames=100, custom_game_kwargs=game_kwargs)